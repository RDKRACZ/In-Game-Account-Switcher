...
public class SkinRenderer {
	...
	public static void loadAllAsync(Minecraft mc, boolean forceRecache, Runnable onEnd) {
		LoadingGui oldov = mc.getOverlay();
	...
	public static void loadSkin(Minecraft mc, String name, UUID uuid, boolean forceRecache) {
		loadSkin(mc, name, uuid, new File(new File(mc.gameDirectory, "cachedImages/models"), name + ".png"),
				new File(new File(mc.gameDirectory, "cachedImages/faces"), name + ".png"), forceRecache);
	}
