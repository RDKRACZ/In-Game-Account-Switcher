...
public class IASConfigScreen extends Screen {
	...
	@Override
	public void init() {
		addButton(caseS = new CheckboxWidget(width / 2 - textRenderer.getWidth(new TranslatableText("ias.cfg.casesensitive")) / 2 - 24, 40, 20, 20, new TranslatableText("ias.cfg.casesensitive"), Config.caseSensitiveSearch));
		addButton(mpscreen = new CheckboxWidget(width / 2 - textRenderer.getWidth(new TranslatableText("ias.cfg.mpscreen")) / 2 - 24, 60, 20, 20, new TranslatableText("ias.cfg.mpscreen"), Config.showOnMPScreen));
		addButton(titlescreen = new CheckboxWidget(width / 2 - textRenderer.getWidth(new TranslatableText("ias.cfg.titlescreen")) / 2 - 24, 80, 20, 20, new TranslatableText("ias.cfg.titlescreen"), Config.showOnTitleScreen));
		addButton(textX = new TextFieldWidget(textRenderer, width / 2 - 100, 110, 98, 20, new LiteralText("X")));
		addButton(textY = new TextFieldWidget(textRenderer, width / 2 + 2, 110, 98, 20, new LiteralText("Y")));
		addButton(btnX = new TextFieldWidget(textRenderer, width / 2 - 100, 152, 98, 20, new LiteralText("X")));
		addButton(btnY = new TextFieldWidget(textRenderer, width / 2 + 2, 152, 98, 20, new LiteralText("Y")));
