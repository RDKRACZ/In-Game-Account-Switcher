...
public class IASConfigScreen extends Screen {
	...
	@Override
	public void removed() {
		Config.caseSensitiveSearch = caseS.func_212942_a(); //isChecked()
		Config.showOnMPScreen = mpscreen.func_212942_a(); //isChecked()
		Config.showOnTitleScreen = titlescreen.func_212942_a(); //isChecked()
	...
	@Override
	public void tick() {
		btnX.visible = titlescreen.func_212942_a(); //isChecked()
		btnY.visible = titlescreen.func_212942_a(); //isChecked()
		textX.tick();
		textY.tick();
		btnX.tick();
		btnY.tick();
	...
	public void render(int mx, int my, float delta) {
		...
		if (titlescreen.func_212942_a()) drawCenteredString(font, I18n.format("ias.cfg.btnpos"), width / 2, 142, -1);
