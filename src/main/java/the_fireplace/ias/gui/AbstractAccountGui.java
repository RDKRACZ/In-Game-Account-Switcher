...
public class AbstractAccountGui extends Screen {
	...
	public void init() {
		...
		username = addRenderableWidget(new EditBox(this.font, this.width / 2 - 100, 60, 200, 20, new TranslatableComponent("ias.username")));
		username.setMaxLength(512);
		password = addRenderableWidget(new GuiPasswordField(this.font, this.width / 2 - 100, 90, 200, 20, new TranslatableComponent("ias.password")));
